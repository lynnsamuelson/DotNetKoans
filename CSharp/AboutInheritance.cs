...
namespace DotNetKoans.CSharp
{
    public class AboutInheritance : Koan
    {
        public class Dog
        {
            public string Name { get; set; } //C# is doing the getter and setter for you is you put this here
        ...
        public class Chihuahua : Dog //isa understanding 
        {
            ...
            // require a Name.
            public Chihuahua(string name) : base(name) //taking the same thing you passed in and passes to the constructor
            {
            }
